...
export class AppComponent {
  ...
  selectedProblem = 'avg';
  steps: any[] = [];
  inputArray: string | number[] = [2, 1, 5, 1, 3, 2]; // Can be number array or string
  k: number | null = 3; // K can be null for problems not requiring it, or a number for others
  pattern: string = "abc"; // For permutation problem
